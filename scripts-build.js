...
if (/<script\b/i.test(html) || /https?:\/\/(?!github\.com)/i.test(html.replaceAll('https://intent-latch-two.vercel.app', ''))) throw new Error('Unexpected runtime script or external asset');
